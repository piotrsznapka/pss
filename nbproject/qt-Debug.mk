...
# Generated by qmake (2.01a) (Qt 4.7.4) on: wt. kwi 17 19:34:20 2012
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) build/Debug/GNU-Linux-x86/QtApplication_11.0.0/ && $(COPY_FILE) --parents generator.h qcustomplot.h Gui.h obiekt.h konfiguracja.h build/Debug/GNU-Linux-x86/QtApplication_11.0.0/ && $(COPY_FILE) --parents Gui.cpp main.cpp obiekt.cpp konfiguracja.cpp generator.cpp qcustomplot.cpp build/Debug/GNU-Linux-x86/QtApplication_11.0.0/ && (cd `dirname build/Debug/GNU-Linux-x86/QtApplication_11.0.0` && $(TAR) QtApplication_11.0.0.tar QtApplication_11.0.0 && $(COMPRESS) QtApplication_11.0.0.tar) && $(MOVE) `dirname build/Debug/GNU-Linux-x86/QtApplication_11.0.0`/QtApplication_11.0.0.tar.gz . && $(DEL_FILE) -r build/Debug/GNU-Linux-x86/QtApplication_11.0.0
